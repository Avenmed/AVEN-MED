...
const primaryCare = {
  ...
  prepare: {
    ...
    note: "Payment details are confirmed with the office before your first visit; we don't publish pricing here.",
  },
  ...
  faqs: [
    ...
    { q: "How much does a visit cost, and do you take insurance?", a: "We don't publish pricing or coverage details on the site, and we won't quote figures we can't confirm here. Payment details are shared clearly with you before your first visit — please contact the office to confirm current specifics." },
