/* AVEN MED — Assessment: Comprehensive AVEN Assessment. Registry data module. */
import React from 'react';

const comprehensiveAssessment = {
  slug: "assessment/comprehensive-assessment",
  priority: 0.85,
  changefreq: "monthly",
  seo: {
  ...
  serviceName: "Comprehensive AVEN Assessment",
  serviceShort: "The Comprehensive Assessment",
  ...
  priceCallout: {
    price: "$200",
    unit: "up to 60 minutes",
    note: "The $200 is credited toward your treatment — the time you invest moves directly into your care.",
  },

  covers: {
    eyebrow: "What It Covers",
    headline: <>Built for the whole <em>picture.</em></>,
    intro: "The Comprehensive Assessment is designed to go wide and deep. It may include:",
    items: [
      { name: "Multiple Concerns", note: "Space to discuss several goals at once and how they relate to one another." },
      { name: "Full History & Goals Review", note: "An in-depth look at your health history, medications, and what you want to achieve." },
      { name: "Complete Planning", note: "A considered plan that thinks about sequence, priority, and timing." },
      { name: "Treatment Roadmap", note: "A written plan you keep — what to do first, what can wait, and why." },
      { name: "Wellness Review", note: "Where relevant, your metabolic health, energy, and preventive goals folded into the picture." },
      { name: "Long-Term Care Planning", note: "A view that looks past today toward maintaining results and health over time." },
    ],
  },
  ...
  compare: {
    eyebrow: "Comprehensive vs. Quick",
    headline: <>How it differs from the Quick <em>Assessment.</em></>,
    body: [
      "The Quick AVEN Assessment is a short, focused read — ideal for a single concern or a first opinion. The Comprehensive Assessment is the in-depth version: more time, multiple concerns, full planning, and a written roadmap you take with you.",
      "Choose Comprehensive when you have several things you'd like to address, want a long-term plan, or would like to bring wellness and preventive goals into the conversation. If you simply want a quick expert read on one thing, the Quick Assessment is the more natural start.",
    ],
    note: "Both are credited toward your treatment, so the choice is about depth — not whether the time is worthwhile.",
  },

  crossLinksIntro: "A comprehensive plan often spans more than one part of the practice:",
  crossLinks: [
  ...
  finalCta: {
    headline: <>Plan the whole <em>picture.</em></>,
    copy: "Begin with a Comprehensive AVEN Assessment — in-depth time and a written roadmap, credited toward your treatment.",
  },
