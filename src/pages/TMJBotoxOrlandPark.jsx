...
const tmj = {
  ...
  safety: {
    ...
    items: [
      ...
      { name: "Relief is not guaranteed", note: "Response varies and some patients notice little or no change. This use is not among the approved indications for botulinum toxin, so there is no labeled outcome or frequency data for it — which is exactly why expectations are set explicitly before treatment rather than afterwards." },
