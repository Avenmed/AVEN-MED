...
const hyperhidrosis = {
  ...
  procedureDescription:
    "Neuromodulator treatment for excessive sweating of the underarms, hands or scalp in Orland Park, IL by Alaa Mashal, MSN, APRN, FNP-BC — for appropriate candidates whose sweating is not adequately controlled, following an individualized assessment.",
  ...
  approach: {
    ...
    body: [
      ...
      "That distinction matters more than anything else on this page. Sweating can be a symptom of another condition — a thyroid problem, for instance — so potential secondary causes are evaluated before treatment, rather than reducing the sweating and leaving the reason for it undiagnosed. Where your history raises that question, evaluation comes first.",
      "Then the area itself, because the three regions AVEN treats — underarms, hands and scalp — are not interchangeable. Hands are working tools with grip and fine movement to protect, the scalp carries its own practical considerations, and the underarm is the best studied of the three. What you have already tried matters here too: clinical-strength antiperspirant used correctly is a real treatment, and how far it can realistically get you differs by area.",
    ],
    considers: [
  ...
  treats: {
    ...
    items: [
      { name: "Underarm Sweating", note: "Severe underarm sweating that clinical-strength antiperspirant has not adequately controlled." },
  ...
  comparison: {
    ...
    intro:
      "This is not simply a preference for starting gently. For the underarm, treatment is intended for severe sweating that topical agents have not adequately controlled — topicals genuinely come first there, and for many people they are the end of it. How far a topical can realistically get you differs by area, which is part of what the assessment weighs.",
    items: [
      ...
      { name: "Neuromodulator Treatment", note: "Temporarily reduces sweating in the skin that is treated, typically for several months. Considered for the underarm where topicals have not been enough, and for the hands or scalp as an individual clinical decision." },
  ...
  safety: {
    ...
    intro:
      "This is a prescription medical treatment, and the assessment before it is a genuine part of the safety of it. The points below are drawn from the prescribing information for botulinum toxin, together with AVEN's own practice policies.",
    items: [
      { name: "Rule out another cause first", note: "Excessive sweating can be a symptom of another condition — a thyroid problem, for example — so potential secondary causes are evaluated before treatment, rather than easing the sweating and leaving the cause undiagnosed. Sweating that is generalised, one-sided, night-time or newly started particularly warrants that." },
      { name: "Each area is judged on its own", note: "Expected effects and risks vary by treatment area, so what is known about underarm treatment is not automatically carried across to the hands or scalp. The underarm is the best studied of the three; the hands and scalp are individual clinical decisions, discussed with you on their own terms rather than folded in behind the underarm." },
      { name: "Common after treatment — underarm", note: "Reactions reported with underarm treatment include injection-site pain and bleeding, increased sweating at sites other than the underarm, sore throat and flu-like symptoms. These come from underarm studies, and are not assumed to apply in the same way to the hands or scalp." },
      { name: "Specific to the hands", note: "Weakness of the hand muscles can occur where botulinum toxin is used for sweating of the palms. Because your hands grip, write and work, that possibility is discussed before treatment rather than after, and it is a real reason some people choose not to treat this area." },
      { name: "Specific to the scalp", note: "Less is established about scalp treatment than about the underarm, so we will not put figures on a page that we cannot stand behind. The general botulinum toxin considerations on this page apply, and what to expect for your scalp specifically is a conversation at your assessment." },
  ...
  faqs: [
    ...
    { q: "Which areas do you treat?", a: "The underarms, the hands and the scalp. They are assessed separately rather than treated as one thing, because what the treatment has to work around differs by area — the hands especially, since you use them constantly. What you can expect, and what the risks are, is discussed for the specific area being treated." },
    { q: "Should I try antiperspirants first?", a: "For the underarm, usually yes — and properly. Treatment there is intended for severe sweating that topicals have not adequately controlled, and clinical-strength antiperspirant applied to dry skin at night is genuinely effective for many people. How realistic a topical is for the hands or scalp is part of what we weigh at the assessment rather than a rule." },
    { q: "Could my sweating be a sign of something else?", a: "It can be, which is why the assessment covers it. Potential secondary causes — a thyroid problem, for example — are evaluated before treatment, so the sweating is not simply eased while the reason for it goes undiagnosed. Sweating that is generalised, one-sided, night-time or new especially warrants a look." },
    ...
    { q: "Will I stop sweating everywhere?", a: "No, and you should not want to. The effect is confined to the skin that was treated, so the rest of your body sweats normally and can still regulate your temperature. Increased sweating at other sites was among the reactions reported with underarm treatment." },
    { q: "Will treating my hands affect my grip?", a: "It is the main area-specific risk to know about: weakness of the hand muscles can occur where botulinum toxin is used for sweating of the palms. Your hands grip, write and work, so this is discussed properly before anything is agreed — and for some people it is a good reason to treat a different area, or none." },
