...
import { DividerMark, Eyebrow, Ph, Reveal, HeroBg, AssessmentCTA } from '../components.jsx';
...
const AestheticsPage = ({ navigate }) => {
  ...
  return (
    <main className="page">
      ...
      {/* CATEGORY NAV */}
      <section style={{ borderTop: "1px solid var(--hairline)", borderBottom: "1px solid var(--hairline)", padding: "18px 0" }}>
