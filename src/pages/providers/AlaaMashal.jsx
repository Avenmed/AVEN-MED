...
const alaaMashal = {
  ...
  changefreq: "monthly",
  seo: {
    title: "Alaa Mashal, MSN, APRN, FNP-BC | AVEN MED",
    description: "Founder and Clinical Director of AVEN MED in Orland Park — a board-certified Family Nurse Practitioner and the practice's only injector.",
  },
